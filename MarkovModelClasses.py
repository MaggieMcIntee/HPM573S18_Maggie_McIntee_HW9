...
class PatientStateMonitor:
    ...
    def __init__(self, parameters):
        ...
        self._ifhadStroke = False   # if the patient had a stroke
    ...
    def update(self, k, next_state):
        ...
        if self._currentState != P.HealthStats.STROKE and next_state == P.HealthStats.STROKE:
            ...
            self._timeToStroke = self._delta_t  # add 1 if the patient develops a stroke
    ...
    def get_these_stroke_times(self):
        """ returns the patient's time to stroke """
        # return time to stroke  only if the patient has had a stroke
...
class CohortOutputs:
    def __init__(self, simulated_cohort):
        ...
        self._timeToStroke = []        # patients' times to AIDS
        ...
        for patient in simulated_cohort.get_patients():
            ...
            if not (time_To_Stroke is None):
                self._timeToStroke.append(time_To_Stroke)
